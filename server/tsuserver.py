...
class TsuServerCC:
    ...
    def send_arup(self, args):
        ...
        self.send_all_cmd_pred('ARUP', *args, pred=lambda x: not x.area.is_hub or not x.area.sub)
		
	def send_hub_arup(self, args):
        """Update the area properties for 2.6 clients.
        ...
        self.send_all_cmd_pred('ARUP', *args, pred=lambda x: x.area.is_hub or x.area.sub)
